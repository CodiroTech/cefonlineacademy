...
export default function QuranTutoringCoursesSection() {
  return (
    <section className="w-full bg-white px-4 lg:px-12 py-8 lg:pt-12 font-poppins">
      <div className="container mx-auto max-w-6xl text-center">
        ...
        <Text className=" sm:px-14 leading-relaxed md:text-center mt-4 mb-5">
          ...
          compassionate, and responsible individuals. <br /> <br /> Our courses cultivate not just understanding, but a lifelong ability to bridge revealed knowledge and acquired knowledge, shaping a
